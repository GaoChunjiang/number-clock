...
webpackJsonpL2Dwidget([0], {
    131: function(t, i, e) {
        ...
        i.theRealInit = function() {
            (0, o.createElement)(),
            o.currCanvas.addEventListener && (window.addEventListener("click", S), window.addEventListener("mousedown", S), window.addEventListener("mousemove", S), window.addEventListener("mouseup", S), document.addEventListener("mouseleave", S), window.addEventListener("touchstart", v), window.addEventListener("touchend", v), window.addEventListener("touchmove", v)),
        ...
        (function(t) {
                        ...
                        if ("#" != n)
                            if ("$" != n) {
                                if ("a" <= n && n <= "z" || "A" <= n && n <= "Z" || "_" == n) {
                                    ...
                                    if ($ >= 0) {
                                        var s = new N;
                                        w.startsWith(t, h, F._$cs) ? (s._$RP = N._$hs, s._$4P = new String(t, h, $ - h)) : w.startsWith(t, h, F._$ar) ? (s._$4P = new String(t, h + 7, $ - h - 7), w.startsWith(t, h + 7, "ANCHOR_X") ? s._$RP = N._$xs : w.startsWith(t, h + 7, "ANCHOR_Y") ? s._$RP = N._$us : w.startsWith(t, h + 7, "SCALE_X") ? s._$RP = N._$qs : w.startsWith(t, h + 7, "SCALE_Y") ? s._$RP = N._$Ys : w.startsWith(t, h + 7, "X") ? s._$RP = N._$ws : w.startsWith(t, h + 7, "Y") && (s._$RP = N._$Ns)) : (s._$RP = N._$Fr, s._$4P = new String(t, h, $ - h)),
                                        i.motions.push(s);
                                        var _ = 0;
            ...
            k.prototype._$7T = function(t) {
                ...
                case STATE_CLOSING:
                    ...
                    break;
                case STATE_CLOSED:
                    (r = (e - this._$bb) / this._$Cb) >= 1 && (this._$_L = V.STATE_OPENING, this._$bb = e),
                    i = 0;
                    break;
                case STATE_OPENING:
                    (r = (e - this._$bb) / this._$mr) >= 1 && (r = 1, this._$_L = V.STATE_INTERVAL, this._$12 = this._$T2()),
                    i = r;
                    break;
                case STATE_INTERVAL:
            ...
            Z.transformPoints_sdk2 = function(i, e, r, o, n, s, _, a) {
                for (var h, $, l, u = r * n, p = 0, c = 0, f = 0, g = 0, y = 0, d = 0, m = !1, T = o; T < u; T += n) {
                    ...
                    if (v = i[T], S = (L = i[T + 1]) * a, (P = v * _) < 0 || S < 0 || _ <= P || a <= S) {
                        ...
                        h = 2 * ((0 | P) + (0 | S) * (_ + 1)),
                        ($ = P - (0 | P)) + (l = S - (0 | S)) < 1 ? (e[T] = s[h] * (1 - $ - l) + s[h + 2] * $ + s[h + 2 * (_ + 1)] * l, e[T + 1] = s[h + 1] * (1 - $ - l) + s[h + 3] * $ + s[h + 2 * (_ + 1) + 1] * l) : (e[T] = s[h + 2 * (_ + 1) + 2] * ($ - 1 + l) + s[h + 2 * (_ + 1)] * (1 - $) + s[h + 2] * (1 - l), e[T + 1] = s[h + 2 * (_ + 1) + 3] * ($ - 1 + l) + s[h + 2 * (_ + 1) + 1] * (1 - $) + s[h + 3] * (1 - l))
                }
            },
            Z.prototype.transformPoints_sdk1 = function(t, i, e, r, o, n, s) {
                for (var _, a, h, $, l, u, p, c = i, f = this._$o, g = this._$A, y = o * s, d = null != c._$hr ? c._$hr : c._$Cr, m = n; m < y; m += s)
                    _t._$ts ? (_ = e[m], a = e[m + 1], _ < 0 ? _ = 0 : _ > 1 && (_ = 1), a < 0 ? a = 0 : a > 1 && (a = 1), $ = 0 | (a *= g), (h = 0 | (_ *= f)) > f - 1 && (h = f - 1), $ > g - 1 && ($ = g - 1), u = _ - h, p = a - $, l = 2 * (h + $ * (f + 1))) : (u = (_ = e[m] * f) - (0 | _), p = (a = e[m + 1] * g) - (0 | a), l = 2 * ((0 | _) + (0 | a) * (f + 1))),
                    u + p < 1 ? (r[m] = d[l] * (1 - u - p) + d[l + 2] * u + d[l + 2 * (f + 1)] * p, r[m + 1] = d[l + 1] * (1 - u - p) + d[l + 3] * u + d[l + 2 * (f + 1) + 1] * p) : (r[m] = d[l + 2 * (f + 1) + 2] * (u - 1 + p) + d[l + 2 * (f + 1)] * (1 - u) + d[l + 2] * (1 - p), r[m + 1] = d[l + 2 * (f + 1) + 3] * (u - 1 + p) + d[l + 2 * (f + 1) + 1] * (1 - u) + d[l + 3] * (1 - p))
            },
            ...
            Mt.setup = function() {
                ...
                if ((e = t.indexOf("iPhone OS ")) >= 0)
                    ...
                    (e = t.indexOf("Android")) >= 0 ? (r.os = "Android", r._isAndroid = !0, r.version = i(t, e + "Android ".length)) : (r.os = "-", r.version = -1)
            },
            _t.init();
            e = !1;
            i.UtSystem = I,
    ...
    133: function(t, i, e) {
        ...
        s.loadJson = function(t) {
            ...
            if (i.setFadeIn(parseInt(e.fade_in) > 0 ? parseInt(e.fade_in) : 1e3), i.setFadeOut(parseInt(e.fade_out) > 0 ? parseInt(e.fade_out) : 1e3), null == e.params)
                return i;
            var r = e.params,
                o = r.length;
            i.paramList = [];
        ...
        a.prototype.updateParam = function(t) {
            ...
            case h.STATE_CLOSING:
                (o = (e - this.stateStartTime) / this.closingMotionMsec) >= 1 && (o = 1, this.eyeState = h.STATE_CLOSED, this.stateStartTime = e),
                i = 1 - o;
                break;
            case h.STATE_CLOSED:
                (o = (e - this.stateStartTime) / this.closedMotionMsec) >= 1 && (this.eyeState = h.STATE_OPENING, this.stateStartTime = e),
                i = 0;
                break;
            case h.STATE_OPENING:
                (o = (e - this.stateStartTime) / this.openingMotionMsec) >= 1 && (o = 1, this.eyeState = h.STATE_INTERVAL, this.nextBlinkTime = this.calcNextBlink()),
                i = o;
                break;
            case h.STATE_INTERVAL:
                this.nextBlinkTime < e && (this.eyeState = h.STATE_CLOSING, this.stateStartTime = e),
                i = 1;
                break;
            case h.STATE_FIRST:
            default:
    ...
    141: function(t, i, e) {
        ...
        a.prototype.setFadeInFadeOut = function(t, i, e, r) {
            ...
            if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, i)), s.cDefine.DEBUG_LOG && console.log("Start motion : " + o), null == this.modelSetting.getMotionSound(t, i))
